...
document.getElementById("bash_cpu_code_snippet").innerText = `curl https://gist.githubusercontent.com/bc/766fb0c70e229b4018caf7c6cbc133e3/raw/4af40d418b1ca641e12b2e16ff57fe4fc9df83d4/client_cpu.py >> /tmp/cpu_runner.py && python3 /tmp/cpu_runner.py ${window.location.protocol}//${window.location.host} ${get_token_from_param()}`
