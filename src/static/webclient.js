...
const client_cpu_link = "https://gist.githubusercontent.com/bc/766fb0c70e229b4018caf7c6cbc133e3/raw/05460d265a504159d443da7ef3f2e8efdb4ec235/client_cpu.py"
document.getElementById("bash_cpu_code_snippet").innerText = `curl -s ${client_cpu_link} >> /tmp/cpu_runner.py && python3 /tmp/cpu_runner.py ${window.location.protocol}//${window.location.host} ${get_token_from_param()}`
